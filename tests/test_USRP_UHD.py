...
class DeviceTests(ossie.utils.testing.ScaComponentTestCase):
    """Test for all device implementations in USRP_UHD"""
    ...
    def testScaBasicBehavior(self):
        ...
        self.assertEqual(self.comp_obj._is_a("IDL:CF/Device:1.0"), True)
...
if __name__ == "__main__":
    ossie.utils.testing.main("../USRP_UHD.spd.xml", testRunner = xmlrunner.XMLTestRunner()) # By default tests all implementations
